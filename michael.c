...
{// Simple Profile Service
  {{ ATT_BT_UUID_SIZE, primaryServiceUUID }, /* type */
    ...
    0,                                        /* handle */
    (uint8 *)&exoTouchProfileService            /* pValue */},
...
static gattAttribute_t exoWandProfileAttrTbl[SERVAPP_NUM_ATTR_SUPPORTED] =     //simpleProfileAttrTbl
{
  // Simple Profile Service
  {
    ...
    GATT_PERMIT_READ,                         /* permissions */
    0,                                        /* handle */
    (uint8 *)&exoWandProfileService            /* pValue */
  },
    ...
    // Characteristic Moto1 Declaration
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoWandProfileMoto1Props
    },

      // Characteristic Value Moto1
      {
        { ATT_BT_UUID_SIZE, exoWandProfileMoto1UUID },
	      ...
	      // Characteristic Moto2 Declaration
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoWandProfileMoto2Props
    },

      // Characteristic Value Moto2
      {
        { ATT_BT_UUID_SIZE, exoWandProfileMoto2UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoWandProfileMoto2
      },
	      ...
	      // Characteristic Moto3 Declaration
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoWandProfileMoto3Props
    },

      // Characteristic Value Moto3
      {
        { ATT_BT_UUID_SIZE, exoWandProfileMoto3UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoWandProfileMoto3
      },
  ...
  // Characteristic Thermo1 Declaration
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoWandProfileThermo1Props
    },

      // Characteristic Value Thermo1
      {
        { ATT_BT_UUID_SIZE, exoWandProfileThermo1UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoWandProfileThermo1
      } 
	...
	// Characteristic Active Declaration active bits 0 - Moto1; 1 - Moto 2; 2 - Moto3 ; 3 - Thermo1
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoWandProfileActiveProps
    },

      // Characteristic Value Active
      {
        { ATT_BT_UUID_SIZE, exoWandProfileActiveUUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoWandProfileActive
      }   
	...
	
   {
      ...
      GATT_PERMIT_READ,
      0,
      &exoWandProfileScriptArray1
    },

      // Characteristic Value Script Array
      {
        { ATT_BT_UUID_SIZE, exoWandProfileScriptArray1UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoWandProfileScriptArray1
      } 
	  ...
	  
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoWandProfileScriptArray8
    },

      // Characteristic Value Script Array
      {
        { ATT_BT_UUID_SIZE, exoWandProfileScriptArray8UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoWandProfileScriptArray8
      } 
...
static gattAttribute_t exoThrustProfileAttrTbl[SERVAPP_NUM_ATTR_SUPPORTED] =     //simpleProfileAttrTbl
{
  // Simple Profile Service
  {
    ...
    GATT_PERMIT_READ,                         /* permissions */
    0,                                        /* handle */
    (uint8 *)&exoThrustProfileService            /* pValue */
  },
    ...
    // Characteristic Moto1 Declaration
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoThrustProfileMoto1Props
    },

      // Characteristic Value Moto1
      {
        { ATT_BT_UUID_SIZE, exoThrustProfileMoto1UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoThrustProfileMoto1
      },
	      ...
	      // Characteristic Moto2 Declaration
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoThrustProfileMoto2Props
    },

      // Characteristic Value Moto2
      {
        { ATT_BT_UUID_SIZE, exoThrustProfileMoto2UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoThrustProfileMoto2
      },
	...
	// Characteristic Active Declaration active bits 0 - Moto1; 1 - Moto 2; 
    {
      ...
      GATT_PERMIT_READ,
      0,
      &exoThrustProfileActiveProps
    },

      // Characteristic Value Active
      {
        { ATT_BT_UUID_SIZE, exoThrustProfileActiveUUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoThrustProfileActive
      }   
	...
	
   {
      ...
      GATT_PERMIT_READ,
      0,
      &exoThrustProfileScriptArray1
    },

      // Characteristic Value Script Array
      {
        { ATT_BT_UUID_SIZE, exoThrustProfileScriptArray1UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoThrustProfileScriptArray1
      } 
      ...
      GATT_PERMIT_READ,
      0,
      &exoThrustProfileScriptArray4
    },

      // Characteristic Value Script Array
      {
        { ATT_BT_UUID_SIZE, exoThrustProfileScriptArray4UUID },
        GATT_PERMIT_READ | GATT_PERMIT_WRITE,
        0,
        &exoThrustProfileScriptArray4
      }  
